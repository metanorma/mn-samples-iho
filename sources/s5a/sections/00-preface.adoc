...
The S5-A standard contains the following list of _**B**asic subjects, **F**oundation Science subjects and **H**ydrographic Science subjects_:
...
* Each _topic_ contains _elements_ which are denoted by Bx.y<c> Fx.y<c> or Hx.y<c>.
